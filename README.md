...
<div align="center">
  <table>
    <tr>
      <td align="center"><img src="assets/shot-day-run.png" width="250" /><br/><sub>العالم النهاري · طريق بعلامات وحواجز</sub></td>
      <td align="center"><img src="assets/shot-day-jump.png" width="250" /><br/><sub>تغيير حارة وقفز</sub></td>
      <td align="center"><img src="assets/shot-day-menu.png" width="250" /><br/><sub>القائمة + لوحة النتائج</sub></td>
    </tr>
  </table>
...
- **عالم نهاري منخفض المضلّعات** — شمس بظلال متتالية (cascaded shadows)، سما بتدرّج وسُحب، تلال بعيدة، شجر وبيوت وحواجز ولافتات، وزرع كثيف — كله مبني من أشكال أوّلية، مفيش موديلات جاهزة.
- **تكستشرات مولّدة برمجياً** — الأسفلت والأرض والكتف محسوبين رياضياً وقت التشغيل (ضوضاء بحساب `double` آمن على الويب). **صفر ملفات صور، وصفر ترخيص طرف تالت.**
- **مظهر سينمائي (Post-FX)** — **Bloom**، **ضباب مسافة** يذوّب البعيد في لون السما، وتدرّج ألوان خفيف — كله على مستوى المشهد.
- **أداء مقيس مش مخمّن** — كل عنصر متكرر مرسوم بـ hardware instancing، ورسّام بصفر تخصيص ذاكرة لكل فريم، وأداة قياس أزمنة الفريمات مدمجة. التفاصيل في [`docs/PERFORMANCE.md`](docs/PERFORMANCE.md).
...
- **تحويل بصري كامل: من النيون للنهار** ✅ — عالم نهاري منخفض المضلّعات بشمس وظلال، طريق بعلامات وكتف تراب، حواجز ولافتات وتلال، عملات على شكل أقواس، رامبات قفز، و HUD بكبسولة.
- **تكستشرات إجرائية + اختبارات** ✅ — تكستشرات الأسطح محسوبة وقت التشغيل، والرياضيات النقية اتفصلت في مكتبة مستقلة عليها **34 اختبار** (اللعبة نفسها مينفعش يتعمل لها widget test — محتاجة GPU).
- **تمريرة أداء مقيسة** ✅ — إصلاح إعداد الظلال (نقلة 3×)، تحويل كل العناصر المتكررة لـ instancing، ورسّام بصفر تخصيص. النتايج والمنهج كلها متسجّلة في [`docs/PERFORMANCE.md`](docs/PERFORMANCE.md).
